...
module.exports = {
    ...
    scale_tickets_step_four:{
        ...
        species_ro: 'RO',
        grade_two: '2',
        tap_to_edit: '//android.widget.TextView[@text="RO"]',
        species_list_ro: '~RO - RED OAK',
        grade_list_two: '~2',
        specie_back: '//android.widget.TextView[@text=""]',
    ...
    scaleTicketsPageFour ( ) {
        ...
        I.fillField(this.scale_tickets_step_four.species, casual.log.log_species_ro)
        ...
        I.fillField(this.scale_tickets_step_four.grade, casual.log.log_grade_2)
        I.touchPerform([
            {
        ...
        I.tap(this.scale_tickets_step_four.tap_to_edit)
        /*I.touchPerform([{
            action: 'tap',
            options: {
                x: 229,
        ...
        I.tap(this.scale_tickets_step_four.edit_log)
        I.tap(this.scale_tickets_step_four.species)
        I.see(this.scale_tickets_step_four.species_ro)
        I.tap(this.scale_tickets_step_four.grade)
        I.seeElement(this.scale_tickets_step_four.grade_two)
        I.touchPerform([
            {
        ...
        I.pressKey('Enter')
        I.wait(2)
        I.tap(this.scale_tickets_step_four.species_list_ro)
        I.tap(this.scale_tickets_step_four.grade)
        I.pressKey('Backspace')
        I.pressKey('Enter')
        I.tap(this.scale_tickets_step_four.grade_list_two)
        I.touchPerform([
            {
