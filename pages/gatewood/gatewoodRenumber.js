...
module.exports = {
    ...
    scale_tickets_options:{
        ...
        change_to: '#RenumberScaleTicketsScreen:NewSequenceNumber',
        start_renumber: 'Start Renumber',
        cont: 'CONTINUE',
    },
    ...
    scaleTicketsPageFour ( ) {
        ...
        I.tap(this.scale_tickets_options.renumber)
        I.tap(this.scale_tickets_options.change_to)
        I.fillField(this.scale_tickets_options.change_to, casual.log.new_sequence_number)
...
/*
        ...
        I.tap(this.scale_tickets_options.start_renumber)
