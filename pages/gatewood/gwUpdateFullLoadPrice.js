...
module.exports = {
    ...
    scale_tickets_step_four:{
        ...
        click_a_placeTwo: '//android.view.ViewGroup',
        tally_complete: 'YES',
        back_to: '//android.widget.ImageView',
        back_to_edit: '//android.widget.ImageView',
        
        list_second: '//android.widget.TextView[@text="RO"])[1]',
    ...
    scale_tickets_options:{
        ...
        three_dots: '//android.widget.TextView[@text=""]',
        renumber: '~Option: Renumber',
        full_load: '~Option: Update Full Load',
        reprice: '#UpdateFullLoadPricingScreen:NewAmountInput',
        update: '#UpdateFullLoadPricingScreen:UpdatePricingButton',
        cont: 'CONTINUE',
    },
    ...
    scaleTicketsPageFour ( ) {
        ...
        I.tap(this.scale_tickets_step_four.edit_tally)
        ...
        I.tap(this.scale_tickets_options.three_dots)
        I.tap(this.scale_tickets_options.full_load)
        I.tap(this.scale_tickets_options.reprice)
        I.fillField(this.scale_tickets_options.reprice, casual.log.reprice_value)
...
/*
        ...
        I.tap(this.scale_tickets_step_four.click_a_placeTwo)
        I.wait(1) 
       
        I.tap(this.scale_tickets_options.update)
        ...
        I.tap(this.scale_tickets_step_four.back_to_edit)
        //renumber
