...
// following with lengh and diameter out of range
...
module.exports = {
    ...
    scale_tickets_step_four:{
        ...
        min_max_yes: '#android:id/button1',
        min_max_no: '#android:id/button2',
    ...
    scaleTicketsPageFour ( ) {
        ...
        I.fillField(this.scale_tickets_step_four.species, casual.log.log_species_as)
        I.tap(this.scale_tickets_step_four.length)
        I.fillField(this.scale_tickets_step_four.length, casual.log.as_min_max_lengh)
        I.tap(this.scale_tickets_step_four.diameter)
        I.fillField(this.scale_tickets_step_four.diameter, casual.log.as_min_max_diam)
       ...
       // I.waitForElement(this.scale_tickets_step_four.min_max_yes)
      // I.waitForElement(this.scale_tickets_step_four.min_max_yes)
     //  I.see(this.scale_tickets_step_four.min_max_yes)
        I.tap(this.scale_tickets_step_four.min_max_no)
        I.wait(3)
